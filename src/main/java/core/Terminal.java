 ...
 *
 * Originally created y2s1 Computer Security CA.
 *
...
public class Terminal {
    ...
    public static final String SETTINGS_FILE_PATH = "toll.properties";
    ...
    /**
     * toll.Terminal is an abstraction class for dealing with text based terminals. It will test for color support as well
    ...
    /**
     * Adds or removes color based on settings.
     * @param text text to be modified.
     * @return text plus or minus color codes.
     */
    public String modifyColor(String text) {
        if (!this.supportsAnsi) {
            text = text.replaceAll("\u001B\\[38;5;[0-9]+m", "");
        } else {
            text = text.replaceAll("&r", COLOR_RESET);
            text = text.replaceAll("&8", COLOR_GRAY);
            text = text.replaceAll("&9", COLOR_RED);
            text = text.replaceAll("&a", COLOR_GREEN);
            text = text.replaceAll("&b", COLOR_YELLOW);
            text = text.replaceAll("&c", COLOR_BLUE);
            text = text.replaceAll("&d", COLOR_MAGENTA);
            text = text.replaceAll("&e", COLOR_CYAN);
            text = text.replaceAll("&f", COLOR_WHITE);
